...
function test_too_few_colors()
  assert_error(nil, function() imlib2.Color(255, 255, nil, nil) end)
  assert_error(nil, function() imlib2.Color(nil, nil, nil, 255) end)
end

function test_allow_missing_alpha()
  assert_pass(nil, function() imlib2.Color(255, 255, 255) end)
end

function test_allowed_range()
  assert_error(nil, function() imlib2.Color(255, 255, 255, 256) end)
  assert_error(nil, function() imlib2.Color(256, 255, 255, 255) end)
  assert_error(nil, function() imlib2.Color(0, 0, -1, 0) end)
  assert_error(nil, function() imlib2.Color(0, -1, -1, 0) end)
end

module("querying and modifying an existing color", lunit.testcase)

function setup()
  col = imlib2.Color(0, 0, 0, 255)
end
